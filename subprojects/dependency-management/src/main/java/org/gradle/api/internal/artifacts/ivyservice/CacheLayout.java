...
public enum CacheLayout {
    ...
    public String getFormattedVersion() {
        if (parent == null) {
            return String.valueOf(versionMapping.getCurrentVersion());
        }
        return parent.getFormattedVersion() + '.' + String.valueOf(versionMapping.getCurrentVersion());
    }
